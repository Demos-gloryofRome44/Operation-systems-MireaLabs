...
#define MSG_READER_FORMAT "Читатель %d (TID: %p): Буфер = %s (читателей: %d)\n"
...
#define MSG_MUTEX_INIT_ERROR "Ошибка инициализации мьютекса: %d\n"
#define MSG_COND_INIT_ERROR "Ошибка инициализации condvar: %d\n"
